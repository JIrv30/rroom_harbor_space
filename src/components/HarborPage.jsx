...
export default function HarborPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (!form.staff_logging) throw new Error('Choose a staff member')
  ...
  return (
    <div className="max-w-5xl mx-auto p-4">
      <div className="flex items-end justify-between gap-4 mb-4">
        <div>
          <h1 className="text-2xl font-bold">Harbor — Overview</h1>
          <p className="text-sm text-gray-500">Showing the 100 most recent entries.</p>
        </div>
        <button
        ...
        <table className="min-w-full text-sm">
          <thead className="bg-gray-50 text-gray-700">
            <tr>
              ...
              <th className="p-2 text-left">Staff logging</th>
          ...
          <tbody>
            {loading ? (
              ...
              <tr><td className="p-3" colSpan={7}>No entries yet.</td></tr>
            ) : (
              rows.map((r) => (
